...
int sem_wait(int sem_id) { return msyscall(SYS_wait, sem_id); }
int sem_post(int sem_id) { return msyscall(SYS_post, sem_id); }
int sem_getvalue(int sem_id) { return msyscall(SYS_getvalue, sem_id); }
int sem_getid(const char *name) { return msyscall(SYS_getid, name); }
